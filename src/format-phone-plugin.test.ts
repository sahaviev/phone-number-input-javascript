...
describe("format-phone-plugin tests", () => {
  beforeEach(() => {
    document.body.innerHTML = `
      <div class="container text-center">
        <input type="tel" id="phone" data-testid="phone" maxlength="16" placeholder="mobile number" autocomplete="off" />
        <div><label for="phone">(123) 456-7890</label></div>
      </div>
    `;
    formatPhonePlugin(document.querySelector('#phone') as HTMLInputElement);
  });
